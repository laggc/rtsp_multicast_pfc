...
public class RtspServerStackImpl implements RtspStack {
	...
	public void start() {
		...
		logger.info("Iniciado el servidor RTSP en:\t" + bindAddress.toString());
	...
	protected void processRtspRequest(HttpRequest httpRequest, Channel channel) {
		synchronized (this.listener) {
			listener.onRtspRequest(httpRequest, channel);
		}
	}
